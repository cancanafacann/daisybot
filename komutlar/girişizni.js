...
if (!arguman) return message.channel.send(`**:x: Lütfen bir bot id yazın.Eğer İzni İptal Etmek İstiyorsan g!giriş-izni ipta botid yapmalısıniriş izni iptal etmek için \`${p}giriş-izni iptal <botid>\`**`)
