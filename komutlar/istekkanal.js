...
exports.run = async (client, message, args) => {
  ...
  .setDescription(`İstek Kanalı ${cfxistekkanal} olarak ayarlandı.Kapatmak İçin g!istek-kanal kapat`)
  .setColor("#0x00000")
  .setFooter(`X-BOT| İstek Kanal Sistemi.`, client.user.avatarURL)
...
exports.help = {
  name: 'istek-kanal',
  description: 'İstek kanalını ayarlar',
