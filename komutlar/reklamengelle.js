...
exports.run = async(client, message, args) => {
 let karaliste = db.fetch(`karaliste_${message.author.id}`);
  ...
  if (args[0] !== 'aç' && args[0] !== 'kapat') return message.channel.send(`:no_entry: Reklam Filtresini Ayarlamak İçin \`s$$reklam-filtre aç\` | Kapatmak İstiyorsanız \`s$$reklam-filtre kapat\` Yazabilirsiniz`)
...
exports.help = {
 ...
 description: 'reklam-filtre',
 usage: 'reklam-filtre aç/kapat'
};