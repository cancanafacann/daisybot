...
exports.run = async (client, message, args) => {
  ...
  .setTitle('BAŞARILI')
  .addField('Sunucu burada tanıtıldı! (Aferin).')
  .addField('12 saat Sonra sunucunuzu Tekrardan Tanıtabilirsiniz.(Bakın 12 saat sonra).')
  .addField('HadiBakalım! (İyi Günler)')
